...
extern "C" int func_ov002_020bf224(void *c, int a, int b);
extern "C" int func_ov002_020bf56c(void *c, int b);
extern "C" void func_ov002_020bf88c(void *c);
extern "C" int func_ov002_020c031c(void *c);
extern "C" int func_ov002_020f035c(unsigned int sel, int r1);
extern "C" int func_0203b0e8(int a, int b);
extern "C" int func_01ffabe4(int a, int b);
extern "C" void ApproachAngle(short *cur, short target, int divisor, int band, int maxStep);
extern "C" void func_ov002_020e30a0(void *c, void *s);
extern "C" void func_ov002_020bedd4(void *c);
extern "C" void func_ov002_020d4540(void *c);
extern "C" void func_ov002_020d454c(void *c);
extern "C" int func_ov002_020d4d88(void *c, int a, int b);
extern "C" void func_ov002_020c18b0(void *c, int a);
extern "C" unsigned char data_020a0e40;
extern "C" short data_0209f4a0[];
extern "C" char data_0209f49c[];
extern "C" char data_0209f4ac[];
extern "C" char data_0209f4ae[];
extern "C" int data_ov002_02110184[];
