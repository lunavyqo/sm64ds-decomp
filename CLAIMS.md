...
| harvest small-band batches (size < 0x100): scaffold-less drafting, spread across modules (addrs 0x020xxxxx) | Session3 (Claude-assisted) | 2026-07-11 | reserved - parallel worker on the <0x100 band via harvest_wl (coddog can't schedule tiny funcs). API claims 401, coordinated via row. |
| ov003 batch: func_ov003_020adc10, 020ae358, 020ae6f4, 020af038, 020af8a0, 020b060c, 020b0730, 020b0894 | lunavyqo (Grok) | 2026-07-11 | **active** PR #268 — 4 MATCH (adc10, b060c, b0730, b0894); ae358 size-exact regperm div≈54; ae6f4 div≈58; af038 size-miss; af8a0 div≈194. Claims API key expired (401). |
