...
| `OBJ_MIP_KEY` | [src/actors/daObj_Mip_Key_c.cpp](../src/actors/daObj_Mip_Key_c.cpp) | [ov085](../config/arm9/overlays/ov085/symbols.txt) `0x0212cc88..0x0212d528` | `d_a_obj_mip_key.cpp` | same | class family plus high/high boundaries | B | TU-name tool has no surviving stem for this interval |
