...
| 0x528 | `mBaseMtx` | `src/_ZN8daOnms_c13InitResourcesEv.cpp` copies `mModel`'s own matrix at 0xf0 into it as a whole `Matrix4x3`; [func_ov092_02131aec.cpp](../src/func_ov092_02131aec.cpp) copies it back out again. The untumbled base transform. |
