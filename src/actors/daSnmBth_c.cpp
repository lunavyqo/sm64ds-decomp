 ...
 * ov027/SnowmanBreathParticle+daSnmBth_c  (16 function(s))
 *
 ...
 *
 * FUNCTION ORDER IS ROM-ASCENDING under #pragma defer_codegen off. One
 * out-of-line daSnmBth_c destructor emits D1 then D0. The breath particle
 * is a member of daSnmBth_c; its functions sit between those destructors
 * and the rest of the actor because that is the cartridge order.
 *
