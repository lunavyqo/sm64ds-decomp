...
extern "C" int func_ov073_021203ac(char* c)
{
    ...
    *(s32*)(c + 0xa8) = 0x5a000;
    ...
    {
        u8* p = (u8*)(((u32)c + 0x4c4) & 0xFFFFFFFFFFFFFFFF);
        u8 b = *p;
        b = (u8)(b + 1);
        *p = b;
        b = *p;
    ...
    _ZN14BlendModelAnim7SetAnimER8BCA_Fileii5Fix12IiEt(c+0x30c,(BCA_File*)data_ov073_021232a8.d[1],4,0,0x1000,0);
    *(s32*)(c + 0x368) = 0x2000;
ret1:
    return 1;
state0:
    {
        Vector3 dir; s16 ha, va; Vector3 vIn, vOut;
        if (*(u8*)(c + 0x4cb) == 2) {
            Vector3* src = (Vector3*)(c + 0x448 + *(u8*)(c + 0x4c4) * 0xc);
            dir.x = src->x; dir.y = src->y; dir.z = src->z;
        } else {
        ...
        { s32 z=0; vIn.x=z;vIn.y=z;vIn.z=z;vOut.x=z;vOut.y=z;vOut.z=z; vIn.z=0x50000; }
        ...
        *(s32*)(c + 0xac) = vOut.z;
        if (_ZNK12WithMeshClsn10IsOnGroundEv(c + 0x150)) {
            *(u8*)(c + 0x4c5) = *(u8*)(c + 0x4c4);
            { s32 z=0; *(s32*)(c+0x98)=z;*(s32*)(c+0xa4)=z;*(s32*)(c+0xa8)=z;*(s32*)(c+0xac)=z; }
            func_ov073_0211f2c0(c, 0x7d0000);
            func_02012694(0x16d, c + 0x74);
            { s32* p=(s32*)(((u32)c+0x4b8)&0xFFFFFFFFFFFFFFFF); *p=*p+1; }
            if (*(s32*)(c + 0x4b8) > 7) func_ov073_0212157c(c, &data_ov073_02123340);
            else func_ov073_0212157c(c, &data_ov073_02123320);
        }
    }
