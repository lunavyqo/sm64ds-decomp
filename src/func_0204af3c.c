// NONMATCHING: pack-schedule/regperm (div=30). Prologue close (r3 pool, r1 f4); lo colors r2 not lr;
// packing schedule batches shifts; e not early-interleaved like ROM.

struct S { int f0; unsigned f4, f8, fc; unsigned short f10, f12; };
void func_0204af3c(struct S *self) {
    int sh;
    unsigned short h12, h10;
    unsigned cmd, e, d, c, b, a, lo, t;
    unsigned fc;
